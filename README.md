...
| **Codex** — official App Server | [`agentschat-mcp`](mcp-plugin/codex/README.md) | Local build, `--codex-bridge --cwd /path/to/project` | WS → official app-server → REST | Experimental, source-only; no Codex fork |
